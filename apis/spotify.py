...
def get_genres_abridged():
    return [
        'acoustic', 'alternative', 'bluegrass', 'blues', 'bossanova',
        'chill', 'classical', 'country', 'dance', 'disco', 'edm',
        'electronic', 'folk', 'french', 'funk', 'gospel', 'hard-rock',
        'heavy-metal', 'hip-hop', 'house', 'indie', 'indie-pop', 'jazz',
        'k-pop', 'latin', 'metal', 'party', 'piano', 'pop', 'punk',
        'r-n-b', 'rock', 'soul', 'soundtracks'
    ]
...
def get_formatted_tracklist_table_html(tracks:list):
    ...
    df = get_dataframe(flattened_data)
    keys = ['name', 'album_image_url_small', 'artist_name', 'album_name', 'track_player']
    df = df[keys]
